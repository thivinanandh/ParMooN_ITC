...
void TSystemPBE3D::Interpolate(DoubleFunct3D *Exact, double *Sol)
{
...
void TSystemPBE3D::AssembleABRhs()
 {
...
void TSystemPBE3D::GetQuadIntegral(int i, int &N_Points, double * &weights, double *x, double *y, double *z,
...
} // void TSystemPBE3D::GetQuadIntegral(i


void TSystemPBE3D::AssembleIntlMat(int CellNo, double tau, double *XPos, double &fact, double *InternalScaling)
{
...
} // void TSystemPBE3D::AssembleIntlM


void TSystemPBE3D::GetErrors(DoubleFunctVect *Exact, TFEFunction3D *ScalarFunction, double *sol_all, double &l2)
{
