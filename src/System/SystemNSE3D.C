...
void TSystemNSE3D::Solve_Pardiso(double *sol, double *rhs, int iter_num)
{
  int N_LinIter = 0;
  double summ = 0;
  double residual, residual_scalar = 0.0;
  ...
  case DIRECT:
    ...
    case 4:
      ...
      PardisoDirectSolverWithObject(SqmatrixA11[N_Levels - 1], SqmatrixA12[N_Levels - 1], SqmatrixA13[N_Levels - 1],
                          SqmatrixA21[N_Levels - 1], SqmatrixA22[N_Levels - 1], SqmatrixA23[N_Levels - 1],
                          SqmatrixA31[N_Levels - 1], SqmatrixA32[N_Levels - 1], SqmatrixA33[N_Levels - 1],
                          MatrixB1T[N_Levels - 1], MatrixB2T[N_Levels - 1], MatrixB3T[N_Levels - 1],
                          MatrixB1[N_Levels - 1], MatrixB2[N_Levels - 1], MatrixB3[N_Levels - 1], rhs, sol, iter_num, pardiso_solver);
