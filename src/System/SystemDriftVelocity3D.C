/** ************************************************************************ 
* @brief     source file for TSystemDriftVelocity3D
...
TSystemDriftVelocity3D::TSystemDriftVelocity3D(int N_levels, TFESpace3D **fespaces, double **sol, double **rhs, int disctype, int solver)
...
TSystemDriftVelocity3D::~TSystemDriftVelocity3D()
{
  int i;
...
void TSystemDriftVelocity3D::AssembleARhs()
{
  //this is set to true for direct solver factorization
  factorize = true;
...
void TSystemDriftVelocity3D::AssembleSystMat(double *oldrhs, double *oldsol, double *rhs, double *sol
#ifdef _MPI
                                             , double **Rhs_array
#endif
                                             )
...
void TSystemDriftVelocity3D::RestoreMassMat()
{
 int i;
...
void TSystemDriftVelocity3D::Solve(double *sol)
{  
    switch(SOLVER)
     {
      case AMG_SOLVE:
...
void TSystemDriftVelocity3D::Solve_Pardiso(double *sol, int iter_num)
{  
    switch(SOLVER)
     {
...
double TSystemDriftVelocity3D::GetResidual(double *sol)
{
