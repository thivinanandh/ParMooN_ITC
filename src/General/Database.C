...
void TDatabase::SetDefaultParameters()
{
  ...
  ParamDB->LEVELS = 1;
  ParamDB->LEVELS_INTL = 1;
  ParamDB->UNIFORM_STEPS = 1;
  ParamDB->UNIFORM_STEPS_INTL = 1;
  ParamDB->DRIFT_X = 0;
  ParamDB->DRIFT_Y = 0;
  ...
  ParamDB->SC_MG_TYPE_SCALAR_INTL = 0;   
...
void TDatabase::WriteParamDB(char *ExecutedFile)
{
  ...
  OutFile << "PBE_P9: " << ParamDB->PBE_P10 << endl;
