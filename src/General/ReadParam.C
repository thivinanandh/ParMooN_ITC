...
int TDomain::ReadParam(char *ParamFile)
{
  ...
  while (!dat.eof())
  {
   ...
   if (!strcmp(line, "LEVELS_INTL:"))
    {
      dat >> TDatabase::ParamDB->LEVELS_INTL;
      N_Param++;
    }
    ...
    if (!strcmp(line, "UNIFORM_STEPS_INTL:"))
    {
      dat >> TDatabase::ParamDB->UNIFORM_STEPS_INTL;
      N_Param++;
    }
   ...
   if (!strcmp(line, "SMESHFILE:"))                                                                            
    ...
    if (!strcmp(line, "SOLVER_TYPE_INTL:"))
    {
      dat >> TDatabase::ParamDB->SOLVER_TYPE_INTL;
      N_Param++;
    }
    ...
    if (!strcmp(line, "DO_ROM:"))
   {
    ...
    if (!strcmp(line, "SC_MG_TYPE_SCALAR_INTL:"))
    {
      dat >> TDatabase::ParamDB->SC_MG_TYPE_SCALAR_INTL;
      N_Param++;
    }
...
//   
    ...
    if (!strcmp(line, "PBE_P10:"))
    {
      dat >> TDatabase::ParamDB->PBE_P10;
      N_Param++;
    }
    ...
    if (!strcmp(line, "KDP_nu:"))
    {
      dat >> TDatabase::ParamDB->KDP_nu;
      N_Param++;
    }    

    if (!strcmp(line, "KDP_w_sat_1:"))
    {
      dat >> TDatabase::ParamDB->KDP_w_sat_1;
      N_Param++;
    }    

    if (!strcmp(line, "KDP_w_sat_2:"))
    {
      dat >> TDatabase::ParamDB->KDP_w_sat_2;
      N_Param++;
    }    

    if (!strcmp(line, "KDP_g_1:"))
    {
      dat >> TDatabase::ParamDB->KDP_g_1;
      N_Param++;
    }    

    if (!strcmp(line, "KDP_g_2:"))
    {
      dat >> TDatabase::ParamDB->KDP_g_2;
      N_Param++;
    }    

    if (!strcmp(line, "KDP_c_p:"))
    {
      dat >> TDatabase::ParamDB->KDP_c_p;
      N_Param++;
    }    

    if (!strcmp(line, "KDP_lambda:"))
    {
      dat >> TDatabase::ParamDB->KDP_lambda;
      N_Param++;
    }    
