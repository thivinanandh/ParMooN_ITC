...
DiscreteFormMBRhs_Galerkin = new TDiscreteForm3D(MMString, MMString, N_Terms_MatrixMARhs_RTE,
                                 Derivatives_MatrixMARhs_RTE, SpacesNumbers_MatrixMARhs_RTE, 
                                 N_Matrices_MatrixMARhs_RTE, N_Matrices_MatrixMARhs_RTE,
                                 RowSpace_MatrixMARhs_RTE, ColumnSpace_MatrixMARhs_RTE, RhsSpace_MatrixMARhs_RTE,
                                 MatrixMARhsAssemble_RTE, LinCoeff, NULL);

DiscreteFormRhs_Galerkin = new TDiscreteForm3D(MMString, MMString, N_Terms_Rhs_RTE,
                                 Derivatives_Rhs_RTE, SpacesNumbers_Rhs_RTE, N_Matrices_Rhs_RTE, N_Rhs_Rhs_RTE,
                                 RowSpace_Rhs_RTE, ColumnSpace_Rhs_RTE, RhsSpace_Rhs_RTE,
                                 RhsAssemble_RTE, LinCoeff, NULL);    

DiscreteFormBRhs_SUPG = new TDiscreteForm3D(MMString, MMString, N_Terms_MatrixMARhs_SUPG_RTE,
                                 Derivatives_MatrixMARhs_SUPG_RTE, SpacesNumbers_MatrixMARhs_SUPG_RTE, 
                                 N_Matrices_MatrixMARhs_SUPG_RTE, N_Matrices_MatrixMARhs_SUPG_RTE,
                                 RowSpace_MatrixMARhs_SUPG_RTE, ColumnSpace_MatrixMARhs_SUPG_RTE, 
                                 RhsSpace_MatrixMARhs_SUPG_RTE,
                                 MatrixMARhsAssemble_SUPG_RTE, LinCoeff, NULL);
                                 
DiscreteFormRhs_SUPG = new TDiscreteForm3D(MMString, MMString, N_Terms_Rhs_SUPG_RTE,
                                 Derivatives_Rhs_SUPG_RTE, SpacesNumbers_Rhs_SUPG_RTE, N_Matrices_Rhs_SUPG_RTE, N_Rhs_Rhs_SUPG_RTE,
                                 RowSpace_Rhs_SUPG_RTE, ColumnSpace_Rhs_SUPG_RTE, RhsSpace_Rhs_SUPG_RTE,
                                 RhsAssemble_SUPG_RTE, LinCoeff, NULL);    
