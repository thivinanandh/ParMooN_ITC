...
class TDomain
{
  ...
  public:
    ...
    /** @brief TetGen with smesh */
    int TetGen(char *SMESH);

    // read bdparam and use tetgen    
    int TetrameshGen(char *prm, char *smesh);

    TDomain *GetSurfMesh(int *Cell_IDX, int *Joint_IDX);
