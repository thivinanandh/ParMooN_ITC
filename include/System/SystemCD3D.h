...
class TSystemCD3D
{
  protected:
    ...
    /** fespace */
    TFESpace3D **FeSpaces, *fesp[1], *ferhs[16];
    
    /** Boundary condition and Boundary Value */
    BoundCondFunct3D *BoundaryConditions[16]; 
    
    /** Boundary condition and Boundary Value */
    BoundValueFunct3D *BoundaryValues[16];    
    ...
    TDiscreteForm3D *DiscreteFormARhs, *DiscreteRhs;
    
    /** rhs for assemble */
    double **SolArray, **RhsArray, *RHSs[16];
