...
#ifndef __SYSTEMRTE__
#define __SYSTEMRTE__
...
class TSystemRTE : public TSystemTCD3D
{
  protected:
#ifdef _MPI
  ...
  TFESpace3D *FeSpaces_Intl3D;  
  TFEFunction3D *FeFunction_Intl3D,  **SpatialFEFunctions; 
  TFESpace2D *FeSpaces_Intl;

  /** size of internal space */
  int N_DoF_Intl, N_DoF_Intl3D;
  double *Sol_Intl3D, *sol_intl, *rhs_intl, *BE_MatScale;  
...
//     TSquareMatrix3D *sqmatrixS;
 ...
 int *N_Cells_ALL; 
  ...
  public:
    /** constructor */
     TSystemRTE(int N_levels, TFESpace3D **fespaces, double **sol, double **rhs, int disctype, int solver,
