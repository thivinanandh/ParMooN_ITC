...
class TADISystem1D : public TADISystem
{
  ...
  public:
    ...
    TADISystem1D(TFEFunction1D *FEFunction_intl, TSquareMatrix1D *M_internal, TSquareMatrix1D *A_internal,
                           ...
                           double *Defect, double *Intlposl, int n_coord, double *xpos, DoubleFunctND *growthAndNuc);

    /** constructor */
    TADISystem1D(TFEFunction1D *FEFunction_intl, TSquareMatrix1D *M_internal, TSquareMatrix1D *A_internal,
                 int n_coord, double *xpos, double *Sol, double *OldSol, double *b, double *Defect,
    ...
    void SolveAllLevels(double *MatValues_orig, double *SolFromX,  double *AggrRhs, CoeffFctND *BilinearCoeffs,
