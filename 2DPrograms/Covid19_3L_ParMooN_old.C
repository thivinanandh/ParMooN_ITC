...
//
// History:     Implementation started on 12.04.2020
...
int main(int argc, char* argv[])
{
  ...
  TDomain *Domain_Intl_l1 = new TDomain();
  TDomain *Domain_Intl_l2 = new TDomain();
  TDomain *Domain_Intl_l3 = new TDomain();
...
//=========================================================================
  ...
  Generate1DMesh(Domain_Intl_l1, L0, L1, N);
  TCollection *Coll_Intl = Domain_Intl_l1->GetCollection(It_Finest, 0);
  int N_Cells_Intl_l1= Coll_Intl->GetN_Cells();

  cout<< "N_Cells_Internal " << N_Cells_Intl_l1 <<endl;
  ...
  char IString[] = "I";
  TFESpace1D *FeSpace_Intl_l1 = new TFESpace1D(Coll_Intl, IString, IString, TDatabase::ParamDB->ANSATZ_ORDER_INTL);
  int dGDisc, N_L1Dof, N_L1nodal;
  N_L1Dof = FeSpace_Intl_l1->GetN_DegreesOfFreedom();

  if(TDatabase::ParamDB->ANSATZ_ORDER_INTL<-9)
   {
    FeSpace_Intl_l1->SetAsDGSpace(); 
    dGDisc = 1;
  ...
  GetInternalNodalPts(FeSpace_Intl_l1, N_L1nodal, IntlPosL_l1);
  OutPut("Dof PBE Internal space : "<<  N_L1nodal << endl);
  TSquareStructure1D *SqStruct1D_Intl_l1 = new TSquareStructure1D(FeSpace_Intl_l1);
  SqStruct1D_Intl_l1->Sort();
  TSquareMatrix1D *S_Intl_l1, *M_Intl_l1 = new TSquareMatrix1D(SqStruct1D_Intl_l1);
  TSquareMatrix1D *K_Intl_l1, *A_Intl_l1 = new TSquareMatrix1D(SqStruct1D_Intl_l1);
  if(TDatabase::ParamDB->INTL_DISCTYPE==SUPG)
   {
    S_Intl_l1 = new TSquareMatrix1D(SqStruct1D_Intl_l1);
    K_Intl_l1 = new TSquareMatrix1D(SqStruct1D_Intl_l1);
   }

 double *Sol_IntlLoc_l1 = new double[N_L1nodal];
 double *OldSol_IntlLoc_l1 = new double[N_L1nodal];
 double *B_IntlLoc_l1 = new double[N_L1nodal];
 double *defect_IntlLoc_l1 = new double[N_L1nodal];
 double *Sol_Xpos_IntOmegaL2L1 = new double[N_Xpos];

 memset(Sol_IntlLoc_l1, 0, N_L1nodal*SizeOfDouble);
 memset(OldSol_IntlLoc_l1, 0, N_L1nodal*SizeOfDouble);
 memset(B_IntlLoc_l1, 0, N_L1nodal*SizeOfDouble);
 memset(defect_IntlLoc_l1, 0, N_L1nodal*SizeOfDouble);

 TFEFunction1D *FeFunction_Intl = new TFEFunction1D(FeSpace_Intl_l1, IString, IString, Sol_IntlLoc_l1,  N_L1nodal);
//=========================================================================
// l_2 internal domain
//=========================================================================
  ...
  TFESpace1D *FeSpace_Intl_l2 = new TFESpace1D(Coll_Intl_l2, IString, IString, TDatabase::ParamDB->ANSATZ_ORDER_INTL);
  int N_L2Dof = FeSpace_Intl_l2->GetN_DegreesOfFreedom();
...
// l_3 internal domain
//=========================================================================
  N = int(TDatabase::ParamDB->REACTOR_P16);

  Generate1DMesh(Domain_Intl_l3, L0, L1, N);
  TCollection *Coll_Intl_l3 = Domain_Intl_l3->GetCollection(It_Finest, 0);
  int N_Cells_Intl_l3= Coll_Intl_l3->GetN_Cells();

  cout<< "N_Cells_Internal_l3 " << N_Cells_Intl_l3 <<endl;
  TFESpace1D *FeSpace_Intl_l3 = new TFESpace1D(Coll_Intl_l3, IString, IString, TDatabase::ParamDB->ANSATZ_ORDER_INTL);
  int N_L3Dof = FeSpace_Intl_l3->GetN_DegreesOfFreedom();

  if(TDatabase::ParamDB->ANSATZ_ORDER_INTL<-9)
   {
    FeSpace_Intl_l3->SetAsDGSpace();    
   }

  double *IntlPosL_l3;
  int N_L3nodal;
  GetInternalNodalPts(FeSpace_Intl_l3, N_L3nodal, IntlPosL_l3);
  OutPut("Dof PBE Internal_l3 space : "<< N_L3nodal << endl);
  TSquareStructure1D *SqStruct1D_Intl_l3 = new TSquareStructure1D(FeSpace_Intl_l3);
  SqStruct1D_Intl_l3->Sort();
  TSquareMatrix1D *S_Intl_l3, *M_Intl_l3 = new TSquareMatrix1D(SqStruct1D_Intl_l3);
  TSquareMatrix1D *K_Intl_l3, *A_Intl_l3 = new TSquareMatrix1D(SqStruct1D_Intl_l3);
  if(TDatabase::ParamDB->INTL_DISCTYPE==SUPG)
   {
    S_Intl_l3 = new TSquareMatrix1D(SqStruct1D_Intl_l3);
    K_Intl_l3 = new TSquareMatrix1D(SqStruct1D_Intl_l3);
   }

 double *Sol_IntlLoc_l3 = new double[N_L3nodal];
 double *OldSol_IntlLoc_l3 = new double[N_L3nodal];
 double *B_IntlLoc_l3 = new double[N_L3nodal];
 double *defect_IntlLoc_l3 = new double[N_L3nodal];

 memset(Sol_IntlLoc_l3, 0, N_L3nodal*SizeOfDouble);
 memset(OldSol_IntlLoc_l3, 0, N_L3nodal*SizeOfDouble);
 memset(B_IntlLoc_l3, 0, N_L3nodal*SizeOfDouble);
 memset(defect_IntlLoc_l3, 0, N_L3nodal*SizeOfDouble);

 TFEFunction1D *FeFunction_Intl_l3 = new TFEFunction1D(FeSpace_Intl_l3, IString, IString, Sol_IntlLoc_l3,  N_L3nodal);
 ...
 // l_1 system
 //=========================================================================
 int N_l1ADI_Systems = N_Xpos*N_L2nodal*N_L3nodal; 
 TADISystem1D **ADI_System_l1 = new TADISystem1D*[N_l1ADI_Systems];
  int i_x, i_l1, i_l2, i_l3;

//  for(int ii=0; ii<N_l1ADI_Systems; ii++)
// //    cout <<"L3: " << (ii/N_Xpos)/N_L2nodal << " L2: " << (ii/N_Xpos)%N_L2nodal << " xi: " <<  ii%N_Xpos <<endl;
 
 double X_Pos[4];
  for(i=0; i<N_l1ADI_Systems; i++)
  {
   i_l3 = (int)((i/N_Xpos)/N_L2nodal);
   i_l2 = (int)((i/N_Xpos)%N_L2nodal);
   i_x = (int)(i%N_Xpos);
   
   X_Pos[0] =  IntlX[i_x];
   X_Pos[1] =  IntlY[i_x];   
   X_Pos[2] =  IntlPosL_l2[i_l2];
   X_Pos[3] =  IntlPosL_l3[i_l3];  

   ADI_System_l1[i] = new TADISystem1D(FeFunction_Intl, M_Intl_l1, A_Intl_l1, S_Intl_l1, K_Intl_l1,
                                    InitialCondition_Psd_Intl,  BoundValue_LMin, BoundValue_LMax,
                                    Sol_IntlLoc_l1, OldSol_IntlLoc_l1, B_IntlLoc_l1, defect_IntlLoc_l1, IntlPosL_l1, 4, X_Pos,
 ...
 // l_2 system
 //=========================================================================
 int N_l2ADI_Systems = N_Xpos*N_L1nodal*N_L3nodal;
 TADISystem1D **ADI_System_l2 = new TADISystem1D*[N_l2ADI_Systems];

//  for(int ii=0; ii<N_l2ADI_Systems; ii++)
//    cout <<"L3: " << (ii/N_Xpos)/N_L1nodal << " L1: " << (ii/N_Xpos)%N_L1nodal << " xi: " <<  ii%N_Xpos <<endl;
 
  for(i=0; i<N_l2ADI_Systems; i++)
  {
   i_l3 = (int)((i/N_Xpos)/N_L1nodal);
   i_l1 = (int)((i/N_Xpos)%N_L1nodal);
   i_x = (int)(i%N_Xpos);
   
   X_Pos[0] =  IntlX[i_x];
   X_Pos[1] =  IntlY[i_x];   
   X_Pos[2] =  IntlPosL_l1[i_l1];
   X_Pos[3] =  IntlPosL_l3[i_l3];  

   ADI_System_l2[i] = new TADISystem1D(FeFunction_Intl_l2, M_Intl_l2, A_Intl_l2, S_Intl_l2, K_Intl_l2,
                                    InitialCondition_Psd_Intl,  BoundValue_LMin_l2, BoundValue_LMax_l2,
                                    Sol_IntlLoc_l2, OldSol_IntlLoc_l2, B_IntlLoc_l2, defect_IntlLoc_l2, IntlPosL_l2, 4, X_Pos,
 ...
 // l_3system
 //=========================================================================
 int N_l3ADI_Systems = N_Xpos*N_L1nodal*N_L2nodal;  
 TADISystem1D **ADI_System_l3 = new TADISystem1D*[N_l3ADI_Systems];

//  for(int ii=0; ii<N_l3ADI_Systems; ii++)
//    cout <<"L2: " << (ii/N_Xpos)/N_L1nodal << " L1: " << (ii/N_Xpos)%N_L1nodal << " xi: " <<  ii%N_Xpos <<endl;
 
 for(i=0; i<N_l3ADI_Systems; i++)
  {
   i_l2 = (int)((i/N_Xpos)/N_L1nodal);
   i_l1 = (int)((i/N_Xpos)%N_L1nodal);
   i_x = (int)(i%N_Xpos);
   ...
   X_Pos[1] =  IntlY[i_x];   
   X_Pos[2] =  IntlPosL_l1[i_l1];
   X_Pos[3] =  IntlPosL_l2[i_l2];  

   ADI_System_l2[i] = new TADISystem1D(FeFunction_Intl_l2, M_Intl_l2, A_Intl_l2, S_Intl_l2, K_Intl_l2,
                                    InitialCondition_Psd_Intl,  BoundValue_LMin_l2, BoundValue_LMax_l2,
                                    Sol_IntlLoc_l2, OldSol_IntlLoc_l2, B_IntlLoc_l2, defect_IntlLoc_l2, IntlPosL_l3, 4, X_Pos,
#ifdef __L2GROWTHNUCL__   
                                     Get_GrowthAndB_Nuc_L2 
#else
                                     NULL
...
//=========================================================================
int N_NodalDofPos_All = N_Xpos*N_L1nodal*N_L2nodal*N_L3nodal;

double *IntL1L2L3value = new double[N_Xpos];
double *Sol_L3nodalL2nodalXposL1nodal = new double[N_NodalDofPos_All];
// double *OldSol_L3nodalL2nodalXposL1nodal = new double[N_NodalDofPos_All];
...
int N_Dof_All = N_Xpos*N_L1Dof*N_L2nodal;
...
// double *Oldrhs_IntlLoc = new double[N_L1Dof;
...
memset(Sol_L3nodalL2nodalXposL1nodal, 0, N_NodalDofPos_All*SizeOfDouble);
double *Sol_XposL1nodal,  *Sol_L1nodalXdof, *Sol_Xdof;

for(int ii=0; ii<N_L2nodal; ii++)
{
 Sol_XposL1nodal = Sol_L3nodalL2nodalXposL1nodal+(ii*N_L1nodal*N_Xpos);

 for(i=0;i<N_Xpos;i++)
  {
   Sol_L1nodalXdof = Sol_XposL1nodal + i*N_L1nodal;
  
   ADI_System_l1[i]->Interpolate(Sol_L1nodalXdof, InitialCondition);
  }
} //for(int ii=0; ii<N_
   ...
   for(int ii=0; ii<N_L2nodal; ii++)
    {
     ...
     GetOSError(N_L1nodal, ScalarPbeFunctions,  FeSpace_Intl_l1, Sol_L1nodalXdof, N_XDOF, errors, Exact_Psd_Intl);
     l2 += errors[0];
     H1 += errors[1];
    }
...
for(j=0; j<N_L1nodal; j++)
 {
  TDatabase::ParamDB->REACTOR_P29=IntlPosL_l1[j];
...
// assemble the mass matrix for the internal space once for all time steps
  if(TDatabase::ParamDB->INTL_DISCTYPE==FD)
   { AssembleFD_M_StartPtDirichlet(M_Intl_l1); }
  else
   { AssembleM_StartPtDirichlet(FeSpace_Intl_l1, M_Intl_l1);}
 
   /** store the M Mat values, so that no need to restore after every sptl pt. calculatio*/
   int N_Entries = M_Intl_l1->GetN_Entries();
   double *MatValues = new double[N_Entries];
   memcpy(MatValues,  M_Intl_l1->GetEntries(),  N_Entries*SizeOfDouble);
...
// exit(0);
     ...
     //===============================================================================
     GetSol_L2_X_L1_and_Sol_X_IntOmegaL1L2(FeSpace_Intl_l1, FeSpace_Intl_l2, Scalar_FeSpace, N_Xpos, N_L1nodal, N_L2nodal, Sol_L2nodalL1nodalXdof, 
                                           Sol_L3nodalL2nodalXposL1nodal, Sol_L2nodalXposL1dof, Sol_Xpos_IntOmegaL2L1, IntL1L2L3value);

     for(int ii=0; ii<N_L2nodal; ii++)
      {

       Sol_XposL1dof = Sol_L2nodalXposL1dof+(ii*N_L1Dof*N_Xpos);
       Rhs_XposL1dof = Rhs_L2nodalXposL1dof+(ii*N_L1Dof*N_Xpos);

       for(i=0;i<N_Xpos;i++)
       {
         Rhs_L1dof = Rhs_XposL1dof+ (i*N_L1Dof);
         Sol_L1dof = Sol_XposL1dof + (i*N_L1Dof);

         GrowthParameters[0] = IntlPosL_l1[i];  // l1
         GrowthParameters[1] = IntlPosL_l2[ii]; //l2
         GrowthParameters[2] = IntL1L2L3value[i]; //\int_\Omega_(l1xl2)

          ADI_System_l1[i]->SolveAllLevels(MatValues, Sol_L1dof, Rhs_L1dof, BilinearCoeffs_Psd_Intl, GrowthParameters, tau, cond_Lmin, cond_Lmax); 
       }

        Sol_XposL1nodal = Sol_L3nodalL2nodalXposL1nodal+(ii*N_L1nodal*N_Xpos);
        Sol_L1nodalXdof = Sol_L2nodalL1nodalXdof+(ii*N_L1nodal*N_XDOF);          
        L_Sol2Nodal(FeSpace_Intl_l1, Sol_XposL1dof, N_L1nodal, Sol_XposL1nodal, N_Xpos);   
    ...
    if(m==1 || m % TDatabase::TimeDB->STEPS_PER_IMAGE == 0)
    {
     ...
     for(i=1; i<=N_Xpos; i++)
      OutPut("Covid Population in the state " <<  i << " : " << IntL1L2L3value[N_Xpos - i] <<endl);
