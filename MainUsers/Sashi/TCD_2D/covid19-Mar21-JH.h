...
//     Unlock 11.0: 1 April 2021 - 30 April 2021 (14 days)
  ...
  if(t<30)  
    {  sd = 0.69; }  // from 23rd Mar to 26th Apr,  // no lockdown
  else if(t<40) 
   { sd = 0.69 + (t-30.)*0.07/10.;}   // till  
  else if(t<60) 
   { sd = 0.76 + (t-40.)*0.06/20.; }   // till  
  else if(t<70.) 
   { sd = 0.82 -(t-60.)*0.07/10.;  } //unlock
  else
   { sd = 0.75; }
  ...
  //   {  sd = 0.7225; }  // from 23rd Mar to 26th Apr,  // no lockdown
  // else if(t<65) 
  //  { sd = 0.7225 + (t-35.)*0.058/30.; }   // till   
  // else if(t<80.) 
  //  { sd = 0.7805 -(t-65.)*0.058/15.;  } //unlock
  // else
  //  { sd = 0.7225; }
