...
//     Unlock 11.0: 1 April 2021 - 30 April 2021 (14 days)
  ...
  //  }
   ...
   // Mar21:fit
      if(t<21.)
       ...
       { sd = 0.7 + (t-21.)*0.057/39; } //till end of 2020
      else
       { sd = 0.757 ;} 
  ...
  //   { sd = 0.7; }
  //  else if (t<55)
  //   { sd = 0.7 + (t-21.)*0.057/34; } //10 May, lockdown started
  // else if(t<85) 
  //  { sd = 0.757 + (t-55.)*0.116/30.; }   // till   
  // else if(t<100.) 
  //  { sd = 0.873 -(t-85.)*0.116/15.;  } //unlock
  // else
  //  { sd = 0.757; }
   
  //Mar21: 30 days lockdown (50%)
   if(t<21.)
    { sd = 0.7; }
   else if (t<55)
    { sd = 0.7 + (t-21.)*0.057/34; } //10 May, lockdown started
  else if(t<85) 
   { sd = 0.757 + (t-55.)*0.058/30.; }   // till   
  else if(t<100.) 
   { sd = 0.815 -(t-85.)*0.058/15.;  } //unlock
  else
   { sd = 0.757; }  
    ...
    for(j=0;j<N_LnodalPos[1]; ++j)
     {
      ...
      //   }  
       ...
       if(t<30)
         { 
          f1_R =  0.06 + t*0.0075/30.;
         }
        else if(t<60) 
         { 
          f1_R = 0.0675 + (t-30.)*0.0035/30;  
         }
       else
        {
         f1_R = 0.071;
