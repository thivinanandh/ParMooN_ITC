...
//     Unlock 11.0: 1 April 2021 - 30 April 2021 (14 days)
  ...
  //   {  sd = 0.72; }  // from 23rd Mar to 26th Apr,  // no lockdown
  // else if(t<45) 
  //  { sd = 0.72 + (t-30.)*0.0348/15.; }   // till  
  // else if(t<60) 
  //  { sd = 0.7548 + (t-45.)*0.1352/15.; }   // till
  //  else if(t<67.) 
  //  { sd = 0.89-(t-60.)*0.07/7.; }  //extension of lockdown for 7 days with 50%
  // else if(t<77.) 
  //  { sd = 0.82 -(t-67.)*0.07/10.;  } //unlock, no locldown from 21st May
  // else
  //  { sd = 0.75; }

  //no lockdown TN, fit on 23 May 2021
  // if(t<30)  
  //   {  sd = 0.71; }  // from 23rd Mar to 26th Apr,  // no lockdown
  // else if(t<40) 
  //  { sd = 0.71 + (t-30.)*0.024/10.;}   // till  
  // else  
  //  { sd = 0.734;  }   
    
  // //15 day partial lockdown from 10th May +15 day full lockdown TN, fit on 23 May 2021
  // if(t<30)  
  //   {  sd = 0.71; }  // from 23rd Mar to 26th Apr,  // no lockdown
  // else if(t<40) 
  //  { sd = 0.71 + (t-30.)*0.024/10.;}   // till  
  // else if(t<50)  // 10 May is 48th day
  //  { sd = 0.734;  }   
  // else if(t<65)  // 15 days partial lockdown
  //  { sd = 0.734 + (t-50.)*0.058/15.; }   // till      
  // else if(t<80)  // +15 days full lockdown
  //  { sd = 0.792 + (t-65.)*0.058/15.; }   // till  
  // else if(t<90.) 
  //  { sd = 0.85 -(t-80.)*0.1/10.;  } 
  // else
  //  { sd = 0.75; }

  //50% of 15 day partial lockdown from 10th May +15 day full lockdown TN, fit on 23 May 2021
  if(t<30)  
    {  sd = 0.71; }  // from 23rd Mar to 26th Apr,  // no lockdown
  else if(t<40) 
   { sd = 0.71 + (t-30.)*0.024/10.;}   // till  
   ...
   { sd = 0.734 + (t-50.)*0.029/15.; }   // till      
  else if(t<80)  // +15 days full lockdown
   { sd = 0.763 + (t-65.)*0.029/15.; }   // till  
  else if(t<90.) 
   { sd = 0.792 -(t-80.)*0.042/10.;  } 
  else
   { sd = 0.75; }
  ...
  // //Mar21: 30 days lockdown (75%)
  // if(t<35)  
  //   {  sd = 0.7225; }  // from 23rd Mar to 26th Apr,  // no lockdown
  // else if(t<65) 
  //  { sd = 0.7225 + (t-35.)*0.087/30.; }   // till   
  // else if(t<80.) 
  //  { sd = 0.8095 -(t-65.)*0.087/15.;  } //unlock
  // else
  //  { sd = 0.7225; }

  // // //Mar21: 30 days lockdown (25%)
  // if(t<35)  
  //   {  sd = 0.7225; }  // from 23rd Mar to 26th Apr,  // no lockdown
  // else if(t<65) 
  //  { sd = 0.7225 + (t-35.)*0.029/30.; }   // till   
  // else if(t<80.) 
  //  { sd = 0.7515 -(t-65.)*0.029/15.;  } //unlock
  // else
  //  { sd = 0.7225; }
    ...
    for(j=0;j<N_LnodalPos[1]; ++j)
     {
      ...
      //   }  
       ...
       if(t<30)
         { 
          f1_R =  0.04 + t*0.025/30.;
         }
        else if(t<40) 
         { 
          f1_R = 0.065 + (t-30.)*0.0219/10;  
         }
       else
        {
         f1_R = 0.0869;
